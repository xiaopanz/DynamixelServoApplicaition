...
#include "ui_firstlayoutsqueezewindow.h"

FirstLayoutSqueezeWindow::FirstLayoutSqueezeWindow(ServoUtility *servoUtilityPtr, QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::FirstLayoutSqueezeWindow),
...
void FirstLayoutSqueezeWindow::on_angleSlider_valueChanged(int value)
{
    ui->angleVal->setText(QString::number(value));
}


void FirstLayoutSqueezeWindow::on_velocitySlider_valueChanged(int value)
{
    ui->velocityVal->setText(QString::number(value));
}


void FirstLayoutSqueezeWindow::on_resetButton_clicked()
{
...
void FirstLayoutSqueezeWindow::on_startButton_clicked()
{
    ui->startButton->setEnabled(false);
...
void FirstLayoutSqueezeWindow::on_quitButton_clicked()
{
    ui->startButton->setEnabled(false);
    if (firstReset == 1) {
        // Change servos velocity
